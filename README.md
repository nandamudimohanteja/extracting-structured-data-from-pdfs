...
1. **Clone the repository:**
   ...
   ```
   git clone https://github.com/nmohant/Extracting-Structured-Data-From-PDFs
...
Mohan Teja Nandamudi is a Data Engineer with over 6 years of experience building and optimizing enterprise data pipelines, cloud warehouses, and AI-driven frameworks. He specializes in Python, SQL, and scalable data architectures across AWS, GCP, and Snowflake environments.

Email: mohanteja.0117@gmail.com
LinkedIn: https://www.linkedin.com/in/nmohant/
GitHub: https://github.com/nmohant